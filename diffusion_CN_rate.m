function [coolingrate, coolingtime, Temp_final, misfit_final, rd_final, x_grid, u_final, isbreak, Ibd] ...
    = diffusion_CN_rate(profile_x,profile_C,Weight,initial_x,initial_C,Nx,f_dt,T,coolingpath,DiffCoef,tol_percent)
...
while ~isstop
    i=i+1;
    [iswithbd, timescale, Ci, Ti, misfiti, rd] = goodrate(dTdt, coolingpath, ...
