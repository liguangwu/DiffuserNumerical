function [coolingrate, coolingtime, Temp_final, misfit_final, rd_final, x_grid, u_final, u_final_conv, isbreak, Ibd] ...
    = diffusion_CN_rate(profile_x,profile_C,Weight,initial_x,initial_C,Nx,f_dt,T,coolingpath,DiffCoef,tol_percent,deconv_parameters)
...
while ~isstop
    i=i+1;
    [iswithbd, timescale, Ci, Ci_conv, Ti, misfiti, rd] = goodrate(dTdt, coolingpath, ...
        u0, T0, DiffCoef, dx, x_grid, profile_x, profile_C, Weight, misfit_95cl, f_dt, tol_percent,deconv_parameters);
