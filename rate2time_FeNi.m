function [coolingtime, Temp_final, isbreak] = rate2time_FeNi(app,coolingrate,coolingpath,u0,T0,DiffCoef,dx,f_dt,tol_percent)
...
a1=DiffCoef(1); a2=DiffCoef(3); a3=DiffCoef(4); a4=DiffCoef(6);
