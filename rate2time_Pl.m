function [coolingtime, Temp_final, isbreak] = rate2time_Pl(app,coolingrate,coolingpath,u0,XAn_grid,T0,DiffCoef,dx,f_dt,tol_percent,fO2,P,aSiO2)
...
parfor cr=1:length(coolingrate)
    ...
    D=exp(a1+a2*log(fO2)+a3*XAn_grid+a4/T+a5*P+a6*P/T+a7*log(aSiO2));
