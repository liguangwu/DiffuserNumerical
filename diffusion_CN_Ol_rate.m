function [coolingrate, coolingtime, Temp_final, misfit_final, rd_final, x_grid, u_final, isbreak, Ibd] ...
    = diffusion_CN_Ol_rate(profile_x,profile_C,Weight,initial_x,initial_C,Nx,f_dt,T,coolingpath,DiffCoef,tol_percent,fO2,P,aSiO2)
...
%***********************************************************************************************
[time, misfit, ~, ~, ~, ~,Ibd]= diffusion_CN_Ol(...
    profile_x,profile_C,Weight,initial_x,initial_C,Nx,f_dt,T,DiffCoef,fO2,P,aSiO2);
...
while ~isstop
    i=i+1;
    [iswithbd, timescale, Ci, Ti, misfiti, rd] = goodrate_Ol(dTdt, coolingpath, ...
