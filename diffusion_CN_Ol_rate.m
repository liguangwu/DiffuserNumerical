function [coolingrate, coolingtime, Temp_final, misfit_final, rd_final, x_grid, u_final, u_final_conv, isbreak, Ibd] ...
    = diffusion_CN_Ol_rate(profile_x,profile_C,Weight,initial_x,initial_C,Nx,f_dt,T,coolingpath,DiffCoef,tol_percent,fO2,P,aSiO2,deconv_parameters)
...
while ~isstop
    i=i+1;
    [iswithbd, timescale, Ci, Ci_conv, Ti, misfiti, rd] = goodrate_Ol(dTdt, coolingpath, ...
        u0, T0, DiffCoef, fO2, P, aSiO2, dx, x_grid, profile_x, profile_C, Weight, misfit_95cl, f_dt, tol_percent, deconv_parameters);
